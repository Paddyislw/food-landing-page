  ...
  return (
    ...
    >
      ...
      <div className="w-[50%] flex flex-col md:items-center  mb:w-auto md:px-2">
        <p className="font-bold text-4xl text-primary mb:text-4xl">About Us</p>
        <p className="w-[400px] mt-4 md:text-center mb:w-auto text-gray mb:text-sm">
        ...
        <button className="text-white mt-6 mr-6 border border-white py-3 px-3 rounded-3xl bg-secondary w-[160px] transition-all hover:scale-105 ease-in-out mb:text-sm">Read More</button>
      </div>
    </div>
  );
};
